...
mysql_connect($host, $dbuser, $dbpass) or die('Tidak dapat terhubung dengan database : '. mysql_error());
mysql_select_db($dbname) or die('Database tidak ditemukan : '.mysql_error());
